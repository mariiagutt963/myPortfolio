...
.catch (()=>{
   ...
   <div className="px-4 w-full max-w-[800px] mx-auto">
                    ...
                    <form className="space-y-6" onSubmit={(handleSubmit)}>
                        ...
                        <button type="submit"  className="bg-orange-400 text-white py-3 px-6 rounded font-medium transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(255,255,0,0.7)]">
Send message
                        </button>
                        </form>
                </div>
